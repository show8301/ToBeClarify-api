...
builder.Services.AddScoped<ToBeClarify.Api.Services.Menu.NotificationSounds>();
builder.Services.AddHostedService<ToBeClarify.Api.Services.Menu.MenuNotificationWorker>();
